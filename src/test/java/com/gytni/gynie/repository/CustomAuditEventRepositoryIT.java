package com.gytni.gynie.repository;

import com.gytni.gynie.GynieApp;
import com.gytni.gynie.config.Constants;
import com.gytni.gynie.config.audit.AuditEventConverter;
import com.gytni.gynie.domain.PersistentAuditEvent;
...
import static com.gytni.gynie.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
